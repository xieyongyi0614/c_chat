              ...
              {filteredContacts.map((contact) => (
                ...
                >
                  <div className="relative">
                    ...
                    <span
                      className={`absolute bottom-0 right-0 inline-block h-2.5 w-2.5 rounded-full border-2 border-surface-900 ${
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {contact.signature && (
                      <span className="truncate text-xs text-surface-400">{contact.signature}</span>
                    )}
                  </div>
                </button>
              ))}
        ...
        friendRequests.length > 0 ? (
          <div className="space-y-2 px-2 py-2">
            {friendRequests.map((request) => (
              <div
                key={request.id}
                className="rounded-xl bg-surface-800/50 p-3 border border-surface-200/10"
              >
